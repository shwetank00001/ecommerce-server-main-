...
let transporter = nodemailer.createTransport({
    ...
    secure: Number(process.env.SMPT_PORT) === 465, // true for 465, false for other ports
    auth: {
        user: process.env.SMPT_MAIL, // gmail
        pass: process.env.SMPT_PASSWORD, // pass
    },
});
...
exports.sendMail = async function ({to, subject, text, html}){
    let info = await transporter.sendMail({
        from: '"E-commerce" <shwetankxgod@gmail.com>', // sender address
        to,
        subject,
        text,
        html
